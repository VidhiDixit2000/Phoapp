...
Live demo: https://phoapp.vercel.app Repo: https://github.com/VidhiDixit2000/superapp-dashboard
...
APIs: SampleAPIs for film posters, OpenWeather for current conditions, Wikipedia REST API for random article summaries.
...
Copy .env.example to .env and add your own OpenWeather key (free at openweathermap.org/api):
